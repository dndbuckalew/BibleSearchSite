"""
BTA — Canonical Bible Chapter Metadata
Phase 9.1D — Structural Scope Detection Support

Purpose:
Provides canonical verse counts for Bible chapters.
Used exclusively for detecting full-chapter queries.

No behavioral logic permitted.
Metadata authority only.
"""

# ------------------------------------------------------------------
# Canonical Chapter Verse Counts (Protestant / KJV-compatible)
# Structure:
...
BIBLE_CHAPTER_VERSE_COUNT = {
    ...
    "1 Chronicles": {
        ...
        20: 8, 21: 30, 22: 19, 23: 32, 24: 31, 25: 31, 26: 32, 27: 34, 28: 21, 29: 30
    },
    "2 Chronicles": {
