...
export const metadata: Metadata = {
  title: "Bible Therapy Assistant (BTA) — Beta",
  description:
    "A reflective Bible study assistant focused on understanding context, meaning, and personal reflection.",
};
    ...
    <html lang="en">
      <body className="min-h-screen bg-neutral-50 text-neutral-900 flex flex-col">
        ...
        <div className="w-full bg-amber-100 border-b border-amber-300 text-amber-900 text-sm px-4 py-2 text-center">
          <strong>BETA:</strong> This is an early-release system for reflective
          Bible study. Content may change and should not be considered
        ...
        <footer className="border-t bg-white mt-12">
          <div className="max-w-4xl mx-auto px-4 py-6 text-sm text-neutral-600 space-y-2">
            ...
            <div className="text-xs text-neutral-500 pt-2 space-y-1">
              ...
              <div>© {currentYear} Bible Therapy Assistant — Beta</div>
            </div>
          </div>
        </footer>
      </body>
